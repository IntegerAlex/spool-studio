  ...
  return (
    <ErrorBoundary>
      <div className="space-y-4 p-6">
        ...
        <Card className="p-3 border border-white/[0.06] bg-[var(--color-bg-surface)] rounded-xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1.5">
            <AssetFormDialog
              ...
              onSaved={() => void refreshDashboard()}
              trigger={
                <button className="flex items-center justify-center gap-2 px-4 py-2.5 text-sm text-zinc-400 hover:text-white hover:bg-white/[0.04] rounded-lg transition-colors border border-transparent hover:border-white/[0.06]">
            ...
            <Link
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 text-sm text-zinc-400 hover:text-white hover:bg-white/[0.04] rounded-lg transition-colors border border-transparent hover:border-white/[0.06]"
            >
        ...
        {/* Overview: Reels, Posters, Status Breakdown */}
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          {/* Reels */}
              ...
              <div>
                ...
                <div className="h-1.5 w-full bg-white/[0.06] rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${deliverablesStats.reels.pct}%` }}
                  />
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col justify-between">
              <div>
                ...
                <div className="h-1.5 w-full bg-white/[0.06] rounded-full overflow-hidden">
                  <div
                    className="h-full bg-emerald-500 rounded-full transition-all duration-300"
                    style={{ width: `${deliverablesStats.posters.pct}%` }}
                  />
                </div>
              </div>
              <div className="grid grid-cols-3 gap-2 mt-4 pt-4 border-t border-white/[0.06] text-center">
        ...
        {/* Client Performance Table + Goals */}
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
              ...
              <div className="overflow-x-auto overflow-y-auto max-h-[320px]">
                <table className="w-full text-left border-collapse">
                  <thead className="sticky top-0 bg-[var(--color-bg-surface)]">
                    <tr className="border-b border-white/[0.06] text-xs font-medium uppercase tracking-wider text-zinc-400">
                      <th className="py-2.5 px-4">Client</th>
                      <th className="py-2.5 px-4 text-center">Goal</th>
                      <th className="py-2.5 px-4 text-center">Done</th>
                      <th className="py-2.5 px-4 text-center">Left</th>
                      <th className="py-2.5 px-4 text-center">Progress</th>
                      <th className="py-2.5 px-4 text-right">Next Publish</th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <div>
            <Card className="border border-white/[0.06] bg-[var(--color-bg-surface)] rounded-xl">
              <div className="px-5 py-4 border-b border-white/[0.06]">
                <h3 className="text-sm font-medium text-white">Clients</h3>
                <p className="text-xs text-zinc-500 mt-0.5">Quick access</p>
              </div>
