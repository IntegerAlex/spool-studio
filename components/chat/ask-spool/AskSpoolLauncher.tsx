  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-[60] flex h-11 items-center gap-2 rounded-full border border-[rgba(255,255,255,0.1)] bg-[var(--surface-elevated)] pl-3.5 pr-2 text-[13px] font-medium text-[var(--color-text-primary)] shadow-lg transition-colors hover:bg-[var(--surface-card)]"
      >
        ...
        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-[var(--primary)]/20 text-[var(--primary)]">
          {open ? (
