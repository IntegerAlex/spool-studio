...
import { type AssetPreviewType, getAssetPreviewType } from "@/lib/asset-display"
import {
...
export function AssetPreviewMedia({
  ...
  const containerClassName = compact ? "min-h-[220px]" : "min-h-[420px]"
          ...
          <div className="w-full max-w-md space-y-4 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Use the built-in player below to listen without leaving the CMS.
              </p>
            </div>
            <audio
              controls
          ...
          <DialogHeader className="border-b border-border/60 px-5 py-4 sm:px-6">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div className="space-y-1">
                ...
                <DialogDescription>
                  {description ??
                    "Preview the uploaded asset without leaving the CMS."}
                </DialogDescription>
              </div>
